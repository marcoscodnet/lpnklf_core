...
use Lpnklf\Core\service\IHistoricoEstadoService;
...
/**
 * servicio para HistoricoEstado
 *  
 * @author Marcos
 * @since 28-02-2018
 *
 */
class HistoricoEstadoServiceImpl extends CrudService implements IHistoricoEstadoService {
