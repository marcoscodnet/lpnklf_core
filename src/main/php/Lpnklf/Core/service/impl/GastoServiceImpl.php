...
use Lpnklf\Core\model\MovimientoGasto;
...
use Lpnklf\Core\service\IGastoService;
...
class GastoServiceImpl extends CrudService implements IGastoService {
	...
	/**
	 * (non-PHPdoc)
	 * @see src/main/php/Lpnklf/Core/service/Lpnklf\Core\service.IGastoService::pagar()
	 */
	public function pagar(Gasto $gasto, Cuenta $cuenta, User $user){
		...
		$movimiento->setConcepto( LpnklfUtils::getConceptoMovimientoGasto() );
	...
	/**
	 * (non-PHPdoc)
	 * @see src/main/php/Lpnklf/Core/service/Lpnklf\Core\service.IGastoService::anular()
	 */
	public function anular(Gasto $gasto, User $user){
		...
		if( $gasto->getEstado() == EstadoGasto::Pagado ){
			...
			$contramovimiento->setConcepto( LpnklfUtils::getConceptoMovimientoAnulacionGasto() );
	...
	/**
	 * (non-PHPdoc)
	 * @see src/main/php/Lpnklf/Core/service/Lpnklf\Core\service.IGastoService::getGastosPorVencer()
	 */
