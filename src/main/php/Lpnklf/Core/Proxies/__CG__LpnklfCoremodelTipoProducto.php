 ...
 */
class TipoProducto extends \Lpnklf\Core\model\TipoProducto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Lpnklf\\Core\\model\\TipoProducto' . "\0" . 'nombre', '' . "\0" . 'Lpnklf\\Core\\model\\TipoProducto' . "\0" . 'servicioTecnico'];
        }
